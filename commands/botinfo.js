...
const dbl = new disbot("",client);
module.exports.run = async (client,message,args) => {
   if(!args[0]) return message.channel.send(" Please write bot id.");
   ...
   .setDescription("**[Vote for the bot named "+b.username+"#"+b.discrim+" in DisBotlist.](https://disbotlist.xyz/bot/"+b.botID+"/vote)**")
   ...
   .setFooter("</> with disbotlist npm module.");
