...
console.log("[DisBotlist.xyz]: Botlist/Edit router loaded.");
...
app.post("/bot/:botID/edit", global.checkAuth, async (req, res) => {
    ...
    client.users.fetch(req.params.botID).then(a => {
        client.channels.cache.get(channels.botlog).send(`<:Edited:857128740198023190> <@${req.user.id}> edited <@${req.params.botID}>\n**https://disbotlist.xyz/bot/${rBody['botID']}/**`)
