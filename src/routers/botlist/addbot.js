...
console.log("[DisBotlist.xyz]: Botlist/Add Bot router loaded.");
    ...
    app.post("/addbot", global.checkAuth, async (req,res) => {
      ...
      client.channels.cache.get(channels.botlog).send(`<:Blurple_plus:850830051960291328> <@${req.user.id}> added \`${a.tag}\` \n**https://disbotlist.xyz/bot/${rBody['botID']}/**`)
